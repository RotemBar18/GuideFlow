 ...
 * removes the anchor when the composable leaves composition. Advance-on-tap is
 * handled by the overlay scrim (see consumeTaps), which sits above the host and
 * can observe the tap before the element consumes it.
 */
